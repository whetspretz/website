...
export function UnderConstructionGraphic(): React.JSX.Element {
    ...
    <div className="flex flex-col items-center justify-center py-16 font-mono">
      <div style={{ width: '100%', maxWidth: 180 }}>
        ...
        >
          ...
          {/* Body diamond */}
          <polygon points={diamondPoints} fill="none" stroke={color} strokeWidth={1.2} />

          {/* Inner diamond (spinning) */}
          <g style={{ transformOrigin: `${bodyCx}px ${bodyCy}px` }} className="guardian-body-spin">
            <polygon
