...
export const ABOUT_SLIDES: HideableSlide[] = [
...

  {
    ...
    entries: [
      ...
      { label: 'Big Whale Labs', sublabel: 'Pigeon & Shelfspace', startYear: 2022, startMonth: 4, endMonth: 3, endYear: 2026, details: ['Products:', 'Pigeon (ai quant)', 'LunchBreak (Socialfi)', 'Ketl (ZK Social)' , '$EGGs (FC Mini app)'] },
      { label: 'Doctronic', sublabel: 'Founding Designer', startYear: 2026, startMonth: 4, details: ['*Founding Designer', 'Leading design'] },
    ],
